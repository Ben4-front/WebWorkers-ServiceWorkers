...
Ссылка на проект: https://github.com/Ben4-front/WebWorkers-ServiceWorkers/
[![Build and Deploy](https://github.com/Ben4-front/WebWorkers-ServiceWorkers/actions/workflows/web.yml/badge.svg)](https://github.com/Ben4-front/WebWorkers-ServiceWorkers/actions/workflows/web.yml)
Правила сдачи задания:

Важно: в рамках этого задания можно использовать любой менеджер пакетов
